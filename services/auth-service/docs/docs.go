    ...
    "paths": {
        ...
        "/factories": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Factory payload",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.CreateNewFactory"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/dto.FactoryResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request"
        ...
        "/factory-areas": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Factory area payload",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.CreateNewFactoryArea"
                        }
                    }
                ],
                "responses": {
