...
SERVICES := services/device-service services/collection-service services/auth-service services/api-gateway

# Services that have swagger annotations and need doc generation (excludes api-gateway)
ANNOTATED_SERVICES := services/device-service services/collection-service services/auth-service
